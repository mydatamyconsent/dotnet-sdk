...
namespace com.mydatamyconsent.Model
{
    ...
    /// </summary>
    [DataContract(Name = "OrganizationCategory")]
    public partial class OrganizationCategory : IEquatable<OrganizationCategory>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OrganizationCategory" /> class.
        /// </summary>
        ...
        public OrganizationCategory(Guid createdBy = default(Guid), DateTime createdAtUtc = default(DateTime), Guid? updatedBy = default(Guid?), DateTime? updatedAtUtc = default(DateTime?), ApplicationUser createdByUser = default(ApplicationUser), ApplicationUser updatedByUser = default(ApplicationUser), Guid? deletedBy = default(Guid?), DateTime? deletedAtUtc = default(DateTime?), ApplicationUser deletedByUser = default(ApplicationUser), Guid id = default(Guid), string name = default(string), string logoUrl = default(string), Object metaData = default(Object))
        {
        ...
        {
            return this.Equals(input as OrganizationCategory);
        }

        /// <summary>
        /// Returns true if OrganizationCategory instances are equal
        /// </summary>
        /// <param name="input">Instance of OrganizationCategory to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OrganizationCategory input)
        {
            if (input == null)
                return false;
