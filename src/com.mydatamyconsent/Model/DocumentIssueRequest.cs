...
namespace com.mydatamyconsent.Model
{
    ...
    public partial class DocumentIssueRequest : IEquatable<DocumentIssueRequest>, IValidatableObject
    {
        /// <summary>
        ...
        public DocumentIssueRequest(string documentTypeId = default(string), string identifier = default(string), string name = default(string), string description = default(string), Receiver receiver = default(Receiver), string expiresAtUtc = default(string), string base64PDFDocument = default(string), Object metadata = default(Object))
        {
            ...
            this.DocumentTypeId = documentTypeId ?? throw new ArgumentNullException("documentTypeId is a required property for DocumentIssueRequest and cannot be null");
            // to ensure "identifier" is required (not null)
            this.Identifier = identifier ?? throw new ArgumentNullException("identifier is a required property for DocumentIssueRequest and cannot be null");
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for DocumentIssueRequest and cannot be null");
            // to ensure "description" is required (not null)
            this.Description = description ?? throw new ArgumentNullException("description is a required property for DocumentIssueRequest and cannot be null");
            // to ensure "receiver" is required (not null)
            this.Receiver = receiver ?? throw new ArgumentNullException("receiver is a required property for DocumentIssueRequest and cannot be null");
            // to ensure "base64PDFDocument" is required (not null)
            this.Base64PDFDocument = base64PDFDocument ?? throw new ArgumentNullException("base64PDFDocument is a required property for DocumentIssueRequest and cannot be null");
