...
namespace com.mydatamyconsent.Model
{
    ...
    /// </summary>
    [DataContract(Name = "OrganizationFinancialAccount")]
    public partial class OrganizationFinancialAccount : IEquatable<OrganizationFinancialAccount>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OrganizationFinancialAccount" /> class.
        /// </summary>
        ...
        public OrganizationFinancialAccount(Guid id = default(Guid), Guid organizationId = default(Guid), string beneficiaryName = default(string), string accountNumber = default(string), string routingNumber = default(string), Organization organization = default(Organization), bool isPrimary = default(bool), bool isVerified = default(bool), string logoUrl = default(string), string bankName = default(string), string bankAccountProofUrl = default(string), FileType? fileType = default(FileType?), BankAccountType? bankAccountType = default(BankAccountType?))
        {
            this.Id = id;
        ...
        {
            return this.Equals(input as OrganizationFinancialAccount);
        }

        /// <summary>
        /// Returns true if OrganizationFinancialAccount instances are equal
        /// </summary>
        /// <param name="input">Instance of OrganizationFinancialAccount to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OrganizationFinancialAccount input)
        {
            if (input == null)
                return false;
