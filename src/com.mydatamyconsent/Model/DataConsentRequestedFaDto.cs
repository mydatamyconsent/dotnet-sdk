...
namespace com.mydatamyconsent.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DataConsentRequestedFaDto")]
    public partial class DataConsentRequestedFaDto : IEquatable<DataConsentRequestedFaDto>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DataConsentRequestedFaDto" /> class.
        /// </summary>
        ...
        public DataConsentRequestedFaDto(string drn = default(string), DateTime fromDatetime = default(DateTime), DateTime toDatetime = default(DateTime), Guid? providerId = default(Guid?), FinancialAccountTypes? accountType = default(FinancialAccountTypes?), string accountIdentifier = default(string), List<DataConsentRfaFilterDto> filters = default(List<DataConsentRfaFilterDto>))
        {
            this.Drn = drn;
        ...
        public List<DataConsentRfaFilterDto> Filters { get; set; }
        ...
        {
            return this.Equals(input as DataConsentRequestedFaDto);
        }

        /// <summary>
        /// Returns true if DataConsentRequestedFaDto instances are equal
        /// </summary>
        /// <param name="input">Instance of DataConsentRequestedFaDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DataConsentRequestedFaDto input)
        {
            if (input == null)
                return false;
