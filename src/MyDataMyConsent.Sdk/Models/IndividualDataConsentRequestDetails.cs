...
namespace MyDataMyConsent.Sdk.Models
{
    ...
    public partial class IndividualDataConsentRequestDetails : IEquatable<IndividualDataConsentRequestDetails>
    {
        ...
        public IndividualDataConsentRequestDetails(string receiver = default(string), Guid id = default(Guid), Guid? templateId = default(Guid?), string title = default(string), string description = default(string), string? purpose = default(string?), DataConsentStatus status = default(DataConsentStatus), string? transactionId = default(string?), DateTime createdAtUtc = default(DateTime))
        {
