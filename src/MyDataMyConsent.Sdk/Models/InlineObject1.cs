...
namespace MyDataMyConsent.Sdk.Models
{
    ...
    public partial class InlineObject1 : IEquatable<InlineObject1>
    {
        ...
        public InlineObject1(System.IO.Stream formFile = default(System.IO.Stream))
        {
            // to ensure "formFile" is required (not null)
            if (formFile == null) {
                throw new ArgumentNullException("formFile is a required property for InlineObject1 and cannot be null");
            }
