...
namespace MyDataMyConsent.Sdk.Models
{
    ...
    /// </summary>
    [DataContract(Name = "OrganizationFinancialTransactionsDto")]
    public partial class OrganizationFinancialTransactionsDto : IEquatable<OrganizationFinancialTransactionsDto>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OrganizationFinancialTransactionsDto" /> class.
        /// </summary>
        ...
        public OrganizationFinancialTransactionsDto(Guid id = default(Guid), Guid accountId = default(Guid), string? name = default(string?), Guid instrumentId = default(Guid), string? transactionType = default(string?), int quantity = default(int), double averagePrice = default(double), string? currency = default(string?))
        {
            this.Id = id;
        ...
        {
            return this.Equals(input as OrganizationFinancialTransactionsDto);
        }

        /// <summary>
        /// Returns true if OrganizationFinancialTransactionsDto instances are equal
        /// </summary>
        /// <param name="input">Instance of OrganizationFinancialTransactionsDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OrganizationFinancialTransactionsDto input)
        {
            if (input == null)
            {
                return false;
