...
namespace MyDataMyConsent.Models
{
    ...
    /// </summary>
    [DataContract(Name = "OrganizationConsentRequestTemplateDetails")]
    public partial class OrganizationConsentRequestTemplateDetails : IEquatable<OrganizationConsentRequestTemplateDetails>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OrganizationConsentRequestTemplateDetails" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected OrganizationConsentRequestTemplateDetails() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OrganizationConsentRequestTemplateDetails" /> class.
        /// </summary>
        ...
        public OrganizationConsentRequestTemplateDetails(string id = default(string), string title = default(string), string description = default(string), string purpose = default(string), string shortId = default(string), ConsentRequestTemplateStatus status = default(ConsentRequestTemplateStatus), IndividualConsentRequestTemplateDetailsDataLife dataLife = default(IndividualConsentRequestTemplateDetailsDataLife), IndividualConsentRequestTemplateDetailsRequestLife requestLife = default(IndividualConsentRequestTemplateDetailsRequestLife), IndividualConsentRequestTemplateDetailsDataFrequency dataFrequency = default(IndividualConsentRequestTemplateDetailsDataFrequency), List<IdentityField> identifiers = default(List<IdentityField>), List<DocumentField> documents = default(List<DocumentField>), List<FinancialAccountField> financialAccounts = default(List<FinancialAccountField>), string createdBy = default(string), DateTime createdAtUtc = default(DateTime), DateTime approvedAtUtc = default(DateTime), DateTime publishedAtUtc = default(DateTime), DateTime rejectedAtUtc = default(DateTime), string rejectionReason = default(string))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for OrganizationConsentRequestTemplateDetails and cannot be null");
            }
            this.Id = id;
            // to ensure "title" is required (not null)
            if (title == null)
            {
                throw new ArgumentNullException("title is a required property for OrganizationConsentRequestTemplateDetails and cannot be null");
            }
            this.Title = title;
            // to ensure "description" is required (not null)
            if (description == null)
            {
                throw new ArgumentNullException("description is a required property for OrganizationConsentRequestTemplateDetails and cannot be null");
            }
            this.Description = description;
            // to ensure "shortId" is required (not null)
            if (shortId == null)
            {
                throw new ArgumentNullException("shortId is a required property for OrganizationConsentRequestTemplateDetails and cannot be null");
            }
            ...
            if (createdBy == null)
            {
                throw new ArgumentNullException("createdBy is a required property for OrganizationConsentRequestTemplateDetails and cannot be null");
            }
        ...
        {
            return this.Equals(input as OrganizationConsentRequestTemplateDetails);
        }

        /// <summary>
        /// Returns true if OrganizationConsentRequestTemplateDetails instances are equal
        /// </summary>
        /// <param name="input">Instance of OrganizationConsentRequestTemplateDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OrganizationConsentRequestTemplateDetails input)
        {
            if (input == null)
            {
                return false;
