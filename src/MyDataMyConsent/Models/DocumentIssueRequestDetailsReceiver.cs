...
namespace MyDataMyConsent.Models
{
    ...
    /// </summary>
    [DataContract(Name = "DocumentIssueRequestDetails_receiver")]
    public partial class DocumentIssueRequestDetailsReceiver : IEquatable<DocumentIssueRequestDetailsReceiver>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DocumentIssueRequestDetailsReceiver" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DocumentIssueRequestDetailsReceiver() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DocumentIssueRequestDetailsReceiver" /> class.
        /// </summary>
        ...
        public DocumentIssueRequestDetailsReceiver(string countryIso2Code = default(string), List<KeyValuePair> identifiers = default(List<KeyValuePair>), IdentificationStrategy identificationStrategy = default(IdentificationStrategy))
        {
            // to ensure "countryIso2Code" is required (not null)
            if (countryIso2Code == null)
            {
                throw new ArgumentNullException("countryIso2Code is a required property for DocumentIssueRequestDetailsReceiver and cannot be null");
            }
            this.CountryIso2Code = countryIso2Code;
            // to ensure "identifiers" is required (not null)
            if (identifiers == null)
            {
                throw new ArgumentNullException("identifiers is a required property for DocumentIssueRequestDetailsReceiver and cannot be null");
            }
        ...
        {
            return this.Equals(input as DocumentIssueRequestDetailsReceiver);
        }

        /// <summary>
        /// Returns true if DocumentIssueRequestDetailsReceiver instances are equal
        /// </summary>
        /// <param name="input">Instance of DocumentIssueRequestDetailsReceiver to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DocumentIssueRequestDetailsReceiver input)
        {
            if (input == null)
            {
                return false;
