...
namespace MyDataMyConsent.Models
{
    ...
    /// </summary>
    [DataContract(Name = "IndividualConsentRequestTemplateDetails")]
    public partial class IndividualConsentRequestTemplateDetails : IEquatable<IndividualConsentRequestTemplateDetails>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="IndividualConsentRequestTemplateDetails" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected IndividualConsentRequestTemplateDetails() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="IndividualConsentRequestTemplateDetails" /> class.
        /// </summary>
        ...
        /// <param name="dataFrequency">dataFrequency.</param>
        /// <param name="identifiers">Consent request template identity fields..</param>
        /// <param name="documents">Consent request template document fields..</param>
        /// <param name="medicalRecords">Consent request template medical record fields..</param>
        /// <param name="financialAccounts">Consent request template financial account fields..</param>
        ...
        /// <param name="publishedAtUtc">Consent request template published datetime in UTC timezone..</param>
        ...
        public IndividualConsentRequestTemplateDetails(string id = default(string), string title = default(string), string description = default(string), string purpose = default(string), string shortId = default(string), ConsentRequestTemplateStatus status = default(ConsentRequestTemplateStatus), IndividualConsentRequestTemplateDetailsDataLife dataLife = default(IndividualConsentRequestTemplateDetailsDataLife), IndividualConsentRequestTemplateDetailsRequestLife requestLife = default(IndividualConsentRequestTemplateDetailsRequestLife), IndividualConsentRequestTemplateDetailsDataFrequency dataFrequency = default(IndividualConsentRequestTemplateDetailsDataFrequency), List<IdentityField> identifiers = default(List<IdentityField>), List<DocumentField> documents = default(List<DocumentField>), List<MedicalRecordField> medicalRecords = default(List<MedicalRecordField>), List<FinancialAccountField> financialAccounts = default(List<FinancialAccountField>), string createdBy = default(string), DateTime createdAtUtc = default(DateTime), DateTime approvedAtUtc = default(DateTime), DateTime publishedAtUtc = default(DateTime), DateTime rejectedAtUtc = default(DateTime), string rejectionReason = default(string))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for IndividualConsentRequestTemplateDetails and cannot be null");
            }
            this.Id = id;
            // to ensure "title" is required (not null)
            if (title == null)
            {
                throw new ArgumentNullException("title is a required property for IndividualConsentRequestTemplateDetails and cannot be null");
            }
            this.Title = title;
            // to ensure "description" is required (not null)
            if (description == null)
            {
                throw new ArgumentNullException("description is a required property for IndividualConsentRequestTemplateDetails and cannot be null");
            }
            this.Description = description;
            // to ensure "shortId" is required (not null)
            if (shortId == null)
            {
                throw new ArgumentNullException("shortId is a required property for IndividualConsentRequestTemplateDetails and cannot be null");
            }
            ...
            if (createdBy == null)
            {
                throw new ArgumentNullException("createdBy is a required property for IndividualConsentRequestTemplateDetails and cannot be null");
            }
        ...
        public IndividualConsentRequestTemplateDetailsDataLife DataLife { get; set; }

        /// <summary>
        /// Gets or Sets RequestLife
        /// </summary>
        [DataMember(Name = "requestLife", EmitDefaultValue = false)]
        public IndividualConsentRequestTemplateDetailsRequestLife RequestLife { get; set; }

        /// <summary>
        /// Gets or Sets DataFrequency
        /// </summary>
        [DataMember(Name = "dataFrequency", EmitDefaultValue = false)]
        public IndividualConsentRequestTemplateDetailsDataFrequency DataFrequency { get; set; }

        /// <summary>
        /// Consent request template identity fields.
        /// </summary>
        /// <value>Consent request template identity fields.</value>
        [DataMember(Name = "identifiers", EmitDefaultValue = false)]
        public List<IdentityField> Identifiers { get; set; }

        /// <summary>
        /// Consent request template document fields.
        /// </summary>
        /// <value>Consent request template document fields.</value>
        [DataMember(Name = "documents", EmitDefaultValue = false)]
        public List<DocumentField> Documents { get; set; }

        /// <summary>
        /// Consent request template medical record fields.
        /// </summary>
        /// <value>Consent request template medical record fields.</value>
        [DataMember(Name = "medicalRecords", EmitDefaultValue = false)]
        public List<MedicalRecordField> MedicalRecords { get; set; }

        /// <summary>
        /// Consent request template financial account fields.
        /// </summary>
        /// <value>Consent request template financial account fields.</value>
        [DataMember(Name = "financialAccounts", EmitDefaultValue = false)]
        public List<FinancialAccountField> FinancialAccounts { get; set; }
        ...
        /// </summary>
        /// <value>Consent request template published datetime in UTC timezone.</value>
        [DataMember(Name = "publishedAtUtc", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  DataFrequency: ").Append(DataFrequency).Append("\n");
            ...
            sb.Append("  PublishedAtUtc: ").Append(PublishedAtUtc).Append("\n");
        ...
        {
            return this.Equals(input as IndividualConsentRequestTemplateDetails);
        }

        /// <summary>
        /// Returns true if IndividualConsentRequestTemplateDetails instances are equal
        /// </summary>
        /// <param name="input">Instance of IndividualConsentRequestTemplateDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IndividualConsentRequestTemplateDetails input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.DataFrequency == input.DataFrequency ||
                    (this.DataFrequency != null &&
                    this.DataFrequency.Equals(input.DataFrequency))
                ) && 
                (
                ...
                (
                    this.PublishedAtUtc == input.PublishedAtUtc ||
                    (this.PublishedAtUtc != null &&
                    this.PublishedAtUtc.Equals(input.PublishedAtUtc))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.DataFrequency.GetHashCode();
                }
                ...
                if (this.PublishedAtUtc != null)
                {
                    hashCode = (hashCode * 59) + this.PublishedAtUtc.GetHashCode();
                }
