...
namespace MyDataMyConsent.Models
{
    ...
    /// </summary>
    [DataContract(Name = "CreditCardTransaction")]
    public partial class CreditCardTransaction : IEquatable<CreditCardTransaction>
    {
        ...
        public CreditCardTransaction(string id = default(string), CreditCardTransactionType txnType = default(CreditCardTransactionType), DateTime txnDate = default(DateTime), float amount = default(float), DateTime valueDate = default(DateTime), string narration = default(string), DateTime statementDate = default(DateTime), string mcc = default(string), string maskedCardNumber = default(string))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for CreditCardTransaction and cannot be null");
            }
            this.Id = id;
            ...
            if (narration == null)
            {
                throw new ArgumentNullException("narration is a required property for CreditCardTransaction and cannot be null");
            }
            ...
            if (mcc == null)
            {
                throw new ArgumentNullException("mcc is a required property for CreditCardTransaction and cannot be null");
            }
            this.Mcc = mcc;
            // to ensure "maskedCardNumber" is required (not null)
            if (maskedCardNumber == null)
            {
                throw new ArgumentNullException("maskedCardNumber is a required property for CreditCardTransaction and cannot be null");
            }
        ...
        {
            return this.Equals(input as CreditCardTransaction);
        }

        /// <summary>
        /// Returns true if CreditCardTransaction instances are equal
        /// </summary>
        /// <param name="input">Instance of CreditCardTransaction to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreditCardTransaction input)
        {
            if (input == null)
            {
                return false;
