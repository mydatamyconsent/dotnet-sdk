...
namespace MyDataMyConsent.Models
{
    ...
    /// </summary>
    [DataContract(Name = "DocumentIssueRequest_receiver")]
    public partial class DocumentIssueRequestReceiver : IEquatable<DocumentIssueRequestReceiver>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DocumentIssueRequestReceiver" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DocumentIssueRequestReceiver() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DocumentIssueRequestReceiver" /> class.
        /// </summary>
        ...
        public DocumentIssueRequestReceiver(string countryIso2Code = default(string), List<KeyValuePair> identifiers = default(List<KeyValuePair>), IdentificationStrategy identificationStrategy = default(IdentificationStrategy))
        {
            // to ensure "countryIso2Code" is required (not null)
            if (countryIso2Code == null)
            {
                throw new ArgumentNullException("countryIso2Code is a required property for DocumentIssueRequestReceiver and cannot be null");
            }
            this.CountryIso2Code = countryIso2Code;
            // to ensure "identifiers" is required (not null)
            if (identifiers == null)
            {
                throw new ArgumentNullException("identifiers is a required property for DocumentIssueRequestReceiver and cannot be null");
            }
        ...
        {
            return this.Equals(input as DocumentIssueRequestReceiver);
        }

        /// <summary>
        /// Returns true if DocumentIssueRequestReceiver instances are equal
        /// </summary>
        /// <param name="input">Instance of DocumentIssueRequestReceiver to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DocumentIssueRequestReceiver input)
        {
            if (input == null)
            {
                return false;
