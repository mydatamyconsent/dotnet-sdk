...
namespace MyDataMyConsent.Models
{
    ...
    /// </summary>
    [DataContract(Name = "MedicalRecordField")]
    public partial class MedicalRecordField : IEquatable<MedicalRecordField>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MedicalRecordField" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MedicalRecordField() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MedicalRecordField" /> class.
        /// </summary>
        ...
        public MedicalRecordField(string fieldTitle = default(string), string fieldSlug = default(string), List<string> drns = default(List<string>))
        {
            // to ensure "fieldTitle" is required (not null)
            if (fieldTitle == null)
            {
                throw new ArgumentNullException("fieldTitle is a required property for MedicalRecordField and cannot be null");
            }
            this.FieldTitle = fieldTitle;
            // to ensure "fieldSlug" is required (not null)
            if (fieldSlug == null)
            {
                throw new ArgumentNullException("fieldSlug is a required property for MedicalRecordField and cannot be null");
            }
            this.FieldSlug = fieldSlug;
            // to ensure "drns" is required (not null)
            if (drns == null)
            {
                throw new ArgumentNullException("drns is a required property for MedicalRecordField and cannot be null");
            }
            this.Drns = drns;
        }
        ...
        {
            return this.Equals(input as MedicalRecordField);
        }

        /// <summary>
        /// Returns true if MedicalRecordField instances are equal
        /// </summary>
        /// <param name="input">Instance of MedicalRecordField to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MedicalRecordField input)
        {
            if (input == null)
            {
                return false;
