...
namespace MyDataMyConsent.Models
{
    ...
    /// </summary>
    [DataContract(Name = "FinancialAccountMutualFund")]
    public partial class FinancialAccountMutualFund : IEquatable<FinancialAccountMutualFund>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FinancialAccountMutualFund" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected FinancialAccountMutualFund() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="FinancialAccountMutualFund" /> class.
        /// </summary>
        ...
        public FinancialAccountMutualFund(string type = default(string), string id = default(string), string name = default(string), double investmentValue = default(double), double currentValue = default(double), string currencyCode = default(string), string amc = default(string), string registrar = default(string), string fundName = default(string), string isin = default(string), string folioNumber = default(string), string schemeCode = default(string), string fundType = default(string), string fundCategory = default(string), double units = default(double), string lienUnits = default(string), DateTime creationDate = default(DateTime), Holder holder = default(Holder), bool transactions = default(bool))
        {
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new ArgumentNullException("type is a required property for FinancialAccountMutualFund and cannot be null");
            }
            this.Type = type;
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for FinancialAccountMutualFund and cannot be null");
            }
            this.Id = id;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for FinancialAccountMutualFund and cannot be null");
            }
            this.Name = name;
            ...
            {
                throw new ArgumentNullException("currencyCode is a required property for FinancialAccountMutualFund and cannot be null");
            }
            this.CurrencyCode = currencyCode;
            // to ensure "fundName" is required (not null)
            if (fundName == null)
            {
                throw new ArgumentNullException("fundName is a required property for FinancialAccountMutualFund and cannot be null");
            }
            this.FundName = fundName;
            // to ensure "isin" is required (not null)
            if (isin == null)
            {
                throw new ArgumentNullException("isin is a required property for FinancialAccountMutualFund and cannot be null");
            }
            this.Isin = isin;
            // to ensure "folioNumber" is required (not null)
            if (folioNumber == null)
            {
                throw new ArgumentNullException("folioNumber is a required property for FinancialAccountMutualFund and cannot be null");
            }
            ...
            if (holder == null)
            {
                throw new ArgumentNullException("holder is a required property for FinancialAccountMutualFund and cannot be null");
            }
            this.Holder = holder;
        ...
        {
            return this.Equals(input as FinancialAccountMutualFund);
        }

        /// <summary>
        /// Returns true if FinancialAccountMutualFund instances are equal
        /// </summary>
        /// <param name="input">Instance of FinancialAccountMutualFund to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FinancialAccountMutualFund input)
        {
            if (input == null)
            {
                return false;
