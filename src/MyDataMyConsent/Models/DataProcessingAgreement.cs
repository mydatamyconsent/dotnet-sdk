...
namespace MyDataMyConsent.Models
{
    ...
    public partial class DataProcessingAgreement : IEquatable<DataProcessingAgreement>
    {
        ...
        protected DataProcessingAgreement() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DataProcessingAgreement" /> class.
        /// </summary>
        /// <param name="id">Agreement id. (required).</param>
        ...
        public DataProcessingAgreement(string id = default(string), string version = default(string), string body = default(string), string attachmentUrl = default(string))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for DataProcessingAgreement and cannot be null");
            }
            this.Id = id;
