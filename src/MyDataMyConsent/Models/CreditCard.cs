...
namespace MyDataMyConsent.Models
{
    ...
    public partial class CreditCard : IEquatable<CreditCard>
    {
        ...
        public CreditCard(string id = default(string), string name = default(string), string identifier = default(string), double balance = default(double), CreditCardProfile profile = default(CreditCardProfile), CreditCardSummary summary = default(CreditCardSummary), string maskedAccountNumber = default(string), string linkedAccountRef = default(string), float version = default(float))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for CreditCard and cannot be null");
            }
            this.Id = id;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for CreditCard and cannot be null");
            }
            this.Name = name;
            // to ensure "identifier" is required (not null)
            if (identifier == null)
            {
                throw new ArgumentNullException("identifier is a required property for CreditCard and cannot be null");
            }
            ...
            if (profile == null)
            {
                throw new ArgumentNullException("profile is a required property for CreditCard and cannot be null");
            }
            this.Profile = profile;
            // to ensure "summary" is required (not null)
            if (summary == null)
            {
                throw new ArgumentNullException("summary is a required property for CreditCard and cannot be null");
            }
            this.Summary = summary;
            // to ensure "maskedAccountNumber" is required (not null)
            if (maskedAccountNumber == null)
            {
                throw new ArgumentNullException("maskedAccountNumber is a required property for CreditCard and cannot be null");
            }
            this.MaskedAccountNumber = maskedAccountNumber;
            // to ensure "linkedAccountRef" is required (not null)
            if (linkedAccountRef == null)
            {
                throw new ArgumentNullException("linkedAccountRef is a required property for CreditCard and cannot be null");
            }
