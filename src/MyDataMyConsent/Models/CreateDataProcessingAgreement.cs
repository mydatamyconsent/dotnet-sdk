...
namespace MyDataMyConsent.Models
{
    ...
    public partial class CreateDataProcessingAgreement : IEquatable<CreateDataProcessingAgreement>
    {
        ...
        public CreateDataProcessingAgreement(string version = default(string), string body = default(string), string attachmentUrl = default(string))
        {
            ...
            if (version == null)
            {
                throw new ArgumentNullException("version is a required property for CreateDataProcessingAgreement and cannot be null");
            }
            this._Version = version;
            // to ensure "body" is required (not null)
            if (body == null)
            {
                throw new ArgumentNullException("body is a required property for CreateDataProcessingAgreement and cannot be null");
            }
            this.Body = body;
            // to ensure "attachmentUrl" is required (not null)
            if (attachmentUrl == null)
            {
                throw new ArgumentNullException("attachmentUrl is a required property for CreateDataProcessingAgreement and cannot be null");
            }
        ...
        [DataMember(Name = "attachmentUrl", IsRequired = true, EmitDefaultValue = true)]
