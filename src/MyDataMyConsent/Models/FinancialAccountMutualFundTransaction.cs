...
namespace MyDataMyConsent.Models
{
    ...
    /// </summary>
    [DataContract(Name = "FinancialAccountMutualFundTransaction")]
    public partial class FinancialAccountMutualFundTransaction : IEquatable<FinancialAccountMutualFundTransaction>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="FinancialAccountMutualFundTransaction" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected FinancialAccountMutualFundTransaction() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="FinancialAccountMutualFundTransaction" /> class.
        /// </summary>
        ...
        public FinancialAccountMutualFundTransaction(MutualFundTransactionType type = default(MutualFundTransactionType), string id = default(string), string amc = default(string), string registrar = default(string), string schemeCode = default(string), MutualFundSchemePlan schemePlan = default(MutualFundSchemePlan), string isin = default(string), string amfiCode = default(string), MutualFundFundType fundType = default(MutualFundFundType), MutualFundSchemeOption schemeOption = default(MutualFundSchemeOption), MutualFundSchemeType schemeTypes = default(MutualFundSchemeType), MutualFundSchemeCategory schemeCategory = default(MutualFundSchemeCategory), string ucc = default(string), string amount = default(string), string closingUnits = default(string), string lienUnits = default(string), string nav = default(string), DateTime navDate = default(DateTime), DateTime orderDate = default(DateTime), DateTime executionDate = default(DateTime), string lockinFlag = default(string), string lockinDays = default(string), MutualFundHoldingMode mode = default(MutualFundHoldingMode), string narration = default(string))
        {
            this.Type = type;
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for FinancialAccountMutualFundTransaction and cannot be null");
            }
            this.Id = id;
            // to ensure "amc" is required (not null)
            if (amc == null)
            {
                throw new ArgumentNullException("amc is a required property for FinancialAccountMutualFundTransaction and cannot be null");
            }
            this.Amc = amc;
            // to ensure "registrar" is required (not null)
            if (registrar == null)
            {
                throw new ArgumentNullException("registrar is a required property for FinancialAccountMutualFundTransaction and cannot be null");
            }
            this.Registrar = registrar;
            // to ensure "schemeCode" is required (not null)
            if (schemeCode == null)
            {
                throw new ArgumentNullException("schemeCode is a required property for FinancialAccountMutualFundTransaction and cannot be null");
            }
            ...
            if (isin == null)
            {
                throw new ArgumentNullException("isin is a required property for FinancialAccountMutualFundTransaction and cannot be null");
            }
            this.Isin = isin;
            // to ensure "amfiCode" is required (not null)
            if (amfiCode == null)
            {
                throw new ArgumentNullException("amfiCode is a required property for FinancialAccountMutualFundTransaction and cannot be null");
            }
            ...
            if (ucc == null)
            {
                throw new ArgumentNullException("ucc is a required property for FinancialAccountMutualFundTransaction and cannot be null");
            }
            this.Ucc = ucc;
            // to ensure "amount" is required (not null)
            if (amount == null)
            {
                throw new ArgumentNullException("amount is a required property for FinancialAccountMutualFundTransaction and cannot be null");
            }
            this.Amount = amount;
            // to ensure "closingUnits" is required (not null)
            if (closingUnits == null)
            {
                throw new ArgumentNullException("closingUnits is a required property for FinancialAccountMutualFundTransaction and cannot be null");
            }
            this.ClosingUnits = closingUnits;
            // to ensure "lienUnits" is required (not null)
            if (lienUnits == null)
            {
                throw new ArgumentNullException("lienUnits is a required property for FinancialAccountMutualFundTransaction and cannot be null");
            }
            this.LienUnits = lienUnits;
            // to ensure "nav" is required (not null)
            if (nav == null)
            {
                throw new ArgumentNullException("nav is a required property for FinancialAccountMutualFundTransaction and cannot be null");
            }
            this.Nav = nav;
            ...
            if (lockinFlag == null)
            {
                throw new ArgumentNullException("lockinFlag is a required property for FinancialAccountMutualFundTransaction and cannot be null");
            }
            this.LockinFlag = lockinFlag;
            // to ensure "lockinDays" is required (not null)
            if (lockinDays == null)
            {
                throw new ArgumentNullException("lockinDays is a required property for FinancialAccountMutualFundTransaction and cannot be null");
            }
            ...
            if (narration == null)
            {
                throw new ArgumentNullException("narration is a required property for FinancialAccountMutualFundTransaction and cannot be null");
            }
        ...
        {
            return this.Equals(input as FinancialAccountMutualFundTransaction);
        }

        /// <summary>
        /// Returns true if FinancialAccountMutualFundTransaction instances are equal
        /// </summary>
        /// <param name="input">Instance of FinancialAccountMutualFundTransaction to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FinancialAccountMutualFundTransaction input)
        {
            if (input == null)
            {
                return false;
