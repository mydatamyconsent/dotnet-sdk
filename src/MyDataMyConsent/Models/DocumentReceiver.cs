...
namespace MyDataMyConsent.Models
{
    ...
    public partial class DocumentReceiver : IEquatable<DocumentReceiver>
    {
        ...
        public DocumentReceiver(string countryIso2Code = default(string), List<KeyValuePair> identifiers = default(List<KeyValuePair>), IdentificationStrategy identificationStrategy = default(IdentificationStrategy))
        {
