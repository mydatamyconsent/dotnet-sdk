...
namespace MyDataMyConsent.Models
{
    ...
    public partial class DocumentDigitalSignature : IEquatable<DocumentDigitalSignature>
    {
        ...
        public DocumentDigitalSignature(string name = default(string), string issuedBy = default(string), string issuerName = default(string), string validFromUtc = default(string), string validToUtc = default(string))
        {
            ...
            // to ensure "validFromUtc" is required (not null)
            if (validFromUtc == null)
            {
                throw new ArgumentNullException("validFromUtc is a required property for DocumentDigitalSignature and cannot be null");
            }
            this.ValidFromUtc = validFromUtc;
            // to ensure "validToUtc" is required (not null)
            if (validToUtc == null)
            {
                throw new ArgumentNullException("validToUtc is a required property for DocumentDigitalSignature and cannot be null");
            }
        ...
        [DataMember(Name = "valid_from_utc", IsRequired = true, EmitDefaultValue = true)]
        ...
        [DataMember(Name = "valid_to_utc", IsRequired = true, EmitDefaultValue = true)]
        public string ValidToUtc { get; set; }
