...
namespace MyDataMyConsent.Models
{
    ...
    /// </summary>
    [DataContract(Name = "IndividualConsentRequestDetails")]
    public partial class IndividualConsentRequestDetails : IEquatable<IndividualConsentRequestDetails>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="IndividualConsentRequestDetails" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected IndividualConsentRequestDetails() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="IndividualConsentRequestDetails" /> class.
        /// </summary>
        ...
        public IndividualConsentRequestDetails(string receiver = default(string), string id = default(string), string templateId = default(string), string consentId = default(string), string title = default(string), string description = default(string), string purpose = default(string), DataConsentStatus status = default(DataConsentStatus), string transactionId = default(string), DateTime createdAtUtc = default(DateTime), DateTime expiresAtUtc = default(DateTime))
        {
            // to ensure "receiver" is required (not null)
            if (receiver == null)
            {
                throw new ArgumentNullException("receiver is a required property for IndividualConsentRequestDetails and cannot be null");
            }
            this.Receiver = receiver;
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for IndividualConsentRequestDetails and cannot be null");
            }
            this.Id = id;
            // to ensure "title" is required (not null)
            if (title == null)
            {
                throw new ArgumentNullException("title is a required property for IndividualConsentRequestDetails and cannot be null");
            }
            this.Title = title;
            // to ensure "description" is required (not null)
            if (description == null)
            {
                throw new ArgumentNullException("description is a required property for IndividualConsentRequestDetails and cannot be null");
            }
        ...
        {
            return this.Equals(input as IndividualConsentRequestDetails);
        }

        /// <summary>
        /// Returns true if IndividualConsentRequestDetails instances are equal
        /// </summary>
        /// <param name="input">Instance of IndividualConsentRequestDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IndividualConsentRequestDetails input)
        {
            if (input == null)
            {
                return false;
