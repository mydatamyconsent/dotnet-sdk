...
namespace MyDataMyConsent.Models
{
    ...
    public partial class CreateConsentRequest : IEquatable<CreateConsentRequest>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateConsentRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateConsentRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateConsentRequest" /> class.
        /// </summary>
        /// <param name="consentTemplateId">Consent request template id (required).</param>
        /// <param name="receiver">receiver (required).</param>
        public CreateConsentRequest(string consentTemplateId = default(string), ConsentRequestReceiver receiver = default(ConsentRequestReceiver))
        {
            // to ensure "consentTemplateId" is required (not null)
            if (consentTemplateId == null)
            {
                throw new ArgumentNullException("consentTemplateId is a required property for CreateConsentRequest and cannot be null");
            }
            this.ConsentTemplateId = consentTemplateId;
            // to ensure "receiver" is required (not null)
            if (receiver == null)
            {
                throw new ArgumentNullException("receiver is a required property for CreateConsentRequest and cannot be null");
            }
        ...
        [DataMember(Name = "consentTemplateId", IsRequired = true, EmitDefaultValue = true)]
        public string ConsentTemplateId { get; set; }
