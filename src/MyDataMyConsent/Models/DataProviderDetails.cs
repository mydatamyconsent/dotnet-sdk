...
namespace MyDataMyConsent.Models
{
    ...
    /// </summary>
    [DataContract(Name = "DataProviderDetails")]
    public partial class DataProviderDetails : IEquatable<DataProviderDetails>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DataProviderDetails" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DataProviderDetails() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DataProviderDetails" /> class.
        /// </summary>
        ...
        /// <param name="dataProtectionOfficer">dataProtectionOfficer (required).</param>
        /// <param name="supportedDocumentTypes">supportedDocumentTypes (required).</param>
        /// <param name="supportedAccountTypes">supportedAccountTypes (required).</param>
        public DataProviderDetails(string id = default(string), string name = default(string), string category = default(string), string logoUrl = default(string), string website = default(string), string supportEmail = default(string), string helpLineNumber = default(string), string privacyPolicy = default(string), string termOfService = default(string), DataProtectionOfficer dataProtectionOfficer = default(DataProtectionOfficer), List<SupportedDocumentType> supportedDocumentTypes = default(List<SupportedDocumentType>), List<string> supportedAccountTypes = default(List<string>))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for DataProviderDetails and cannot be null");
            }
            this.Id = id;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for DataProviderDetails and cannot be null");
            }
            this.Name = name;
            // to ensure "category" is required (not null)
            if (category == null)
            {
                throw new ArgumentNullException("category is a required property for DataProviderDetails and cannot be null");
            }
            this.Category = category;
            // to ensure "dataProtectionOfficer" is required (not null)
            if (dataProtectionOfficer == null)
            {
                throw new ArgumentNullException("dataProtectionOfficer is a required property for DataProviderDetails and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("supportedDocumentTypes is a required property for DataProviderDetails and cannot be null");
            }
            this.SupportedDocumentTypes = supportedDocumentTypes;
            // to ensure "supportedAccountTypes" is required (not null)
            if (supportedAccountTypes == null)
            {
                throw new ArgumentNullException("supportedAccountTypes is a required property for DataProviderDetails and cannot be null");
            }
        ...
        /// </summary>
        [DataMember(Name = "helpLineNumber", EmitDefaultValue = false)]
        ...
        /// </summary>
        [DataMember(Name = "termOfService", EmitDefaultValue = false)]
        public string TermOfService { get; set; }

        /// <summary>
        /// Gets or Sets DataProtectionOfficer
        /// </summary>
        [DataMember(Name = "dataProtectionOfficer", IsRequired = true, EmitDefaultValue = true)]
        ...
        public List<SupportedDocumentType> SupportedDocumentTypes { get; set; }

        /// <summary>
        /// Gets or Sets SupportedAccountTypes
        /// </summary>
        [DataMember(Name = "supportedAccountTypes", IsRequired = true, EmitDefaultValue = true)]
        ...
        {
            return this.Equals(input as DataProviderDetails);
        }

        /// <summary>
        /// Returns true if DataProviderDetails instances are equal
        /// </summary>
        /// <param name="input">Instance of DataProviderDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DataProviderDetails input)
        {
            if (input == null)
            {
                return false;
