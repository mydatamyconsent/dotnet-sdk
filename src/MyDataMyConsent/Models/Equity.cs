...
namespace MyDataMyConsent.Models
{
    ...
    public partial class Equity : IEquatable<Equity>
    {
        ...
        public Equity(string id = default(string), string name = default(string), string identifier = default(string), double balance = default(double), Profile profile = default(Profile), EquitySummary summary = default(EquitySummary), string maskedAccountNumber = default(string), string linkedAccountRef = default(string), float version = default(float))
        {
            ...
            if (identifier == null)
            {
                throw new ArgumentNullException("identifier is a required property for Equity and cannot be null");
            }
            ...
            if (profile == null)
            {
                throw new ArgumentNullException("profile is a required property for Equity and cannot be null");
            }
            this.Profile = profile;
            // to ensure "summary" is required (not null)
            if (summary == null)
            {
                throw new ArgumentNullException("summary is a required property for Equity and cannot be null");
            }
            this.Summary = summary;
            // to ensure "maskedAccountNumber" is required (not null)
            if (maskedAccountNumber == null)
            {
                throw new ArgumentNullException("maskedAccountNumber is a required property for Equity and cannot be null");
            }
            this.MaskedAccountNumber = maskedAccountNumber;
            // to ensure "linkedAccountRef" is required (not null)
            if (linkedAccountRef == null)
            {
                throw new ArgumentNullException("linkedAccountRef is a required property for Equity and cannot be null");
            }
