...
namespace MyDataMyConsent.Models
{
    ...
    public partial class IssuedDocument : IEquatable<IssuedDocument>
    {
        ...
        /// <param name="acceptedAtUtc">Accepted datetime in UTC timezone. (required).</param>
        public IssuedDocument(string id = default(string), string identifier = default(string), string documentType = default(string), string issuedTo = default(string), DateTime issuedAtUtc = default(DateTime), DateTime expiresAtUtc = default(DateTime), DateTime acceptedAtUtc = default(DateTime))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for IssuedDocument and cannot be null");
            }
            this.Id = id;
        ...
        [DataMember(Name = "issuedTo", IsRequired = true, EmitDefaultValue = true)]
        ...
        [DataMember(Name = "acceptedAtUtc", IsRequired = true, EmitDefaultValue = true)]
