...
namespace MyDataMyConsent.Api
{
    ...
    public partial class DataProviderDiscoveryApi : IDataProviderDiscoveryApi
    {
        ...
        {
            MyDataMyConsent.Client.ApiResponse<DataProviderPaginatedList> localVarResponse = V1DataProvidersGetWithHttpInfo(accountType, documentType, organizationCategory, pageNo, pageSize, country);
        ...
        public MyDataMyConsent.Client.ApiResponse<DataProviderPaginatedList> V1DataProvidersGetWithHttpInfo(string accountType = default(string), string documentType = default(string), string organizationCategory = default(string), int? pageNo = default(int?), int? pageSize = default(int?), string country = default(string))
        {
            ...
            if (country != null)
            {
                localVarRequestOptions.QueryParameters.Add(MyDataMyConsent.Client.ClientUtils.ParameterToMultiMap("", "country", country));
            }
        ...
        {
            MyDataMyConsent.Client.ApiResponse<DataProviderPaginatedList> localVarResponse = await V1DataProvidersGetWithHttpInfoAsync(accountType, documentType, organizationCategory, pageNo, pageSize, country, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (DataProviderPaginatedList)</returns>
        public async System.Threading.Tasks.Task<MyDataMyConsent.Client.ApiResponse<DataProviderPaginatedList>> V1DataProvidersGetWithHttpInfoAsync(string accountType = default(string), string documentType = default(string), string organizationCategory = default(string), int? pageNo = default(int?), int? pageSize = default(int?), string country = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        {
            MyDataMyConsent.Client.ApiResponse<DataProvider> localVarResponse = V1DataProvidersProviderIdGetWithHttpInfo(providerId);
            return localVarResponse.Data;
        }
        ...
        /// <param name="providerId">Provider Id.</param>
        /// <returns>ApiResponse of DataProvider</returns>
        public MyDataMyConsent.Client.ApiResponse<DataProvider> V1DataProvidersProviderIdGetWithHttpInfo(string providerId)
        {
            // verify the required parameter 'providerId' is set
            if (providerId == null)
            {
                throw new MyDataMyConsent.Client.ApiException(400, "Missing required parameter 'providerId' when calling DataProviderDiscoveryApi->V1DataProvidersProviderIdGet");
            }
        ...
        {
            MyDataMyConsent.Client.ApiResponse<DataProvider> localVarResponse = await V1DataProvidersProviderIdGetWithHttpInfoAsync(providerId, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (DataProvider)</returns>
        public async System.Threading.Tasks.Task<MyDataMyConsent.Client.ApiResponse<DataProvider>> V1DataProvidersProviderIdGetWithHttpInfoAsync(string providerId, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'providerId' is set
            if (providerId == null)
            {
