...
namespace MyDataMyConsent.Api
{
    ...
    public partial class DigiLockerCompatIssuerApi : IDigiLockerCompatIssuerApi
    {
        ...
        /// <returns></returns>
        public DigiLockerCompatIssuerApi(MyDataMyConsent.Client.Configuration configuration)
        {
        ...
        public DigiLockerCompatIssuerApi(MyDataMyConsent.Client.ISynchronousClient client, MyDataMyConsent.Client.IAsynchronousClient asyncClient, MyDataMyConsent.Client.IReadableConfiguration configuration)
        {
        ...
        {
            MyDataMyConsent.Client.ApiResponse<PushUriResponse> localVarResponse = DigilockerCompatIssueDocumentWithHttpInfo(pushUriRequest);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of PushUriResponse</returns>
        public MyDataMyConsent.Client.ApiResponse<PushUriResponse> DigilockerCompatIssueDocumentWithHttpInfo(PushUriRequest pushUriRequest, int operationIndex = 0)
        {
            // verify the required parameter 'pushUriRequest' is set
            if (pushUriRequest == null)
            {
                throw new MyDataMyConsent.Client.ApiException(400, "Missing required parameter 'pushUriRequest' when calling DigiLockerCompatIssuerApi->DigilockerCompatIssueDocument");
            }
        ...
        {
            MyDataMyConsent.Client.ApiResponse<PushUriResponse> localVarResponse = await DigilockerCompatIssueDocumentWithHttpInfoAsync(pushUriRequest, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (PushUriResponse)</returns>
        public async System.Threading.Tasks.Task<MyDataMyConsent.Client.ApiResponse<PushUriResponse>> DigilockerCompatIssueDocumentWithHttpInfoAsync(PushUriRequest pushUriRequest, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'pushUriRequest' is set
            if (pushUriRequest == null)
            {
