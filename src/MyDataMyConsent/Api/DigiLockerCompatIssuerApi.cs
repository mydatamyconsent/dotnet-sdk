...
namespace MyDataMyConsent.Api
{
    ...
    public partial class DigiLockerCompatIssuerApi : IDigiLockerCompatIssuerApi
    {
        ...
        /// <param name="pushUriRequest"> (optional)</param>
        /// <returns>ApiResponse of PushUriResponse</returns>
        public MyDataMyConsent.Client.ApiResponse<PushUriResponse> IssuerIssuedoc1XmlPostWithHttpInfo(PushUriRequest pushUriRequest = default(PushUriRequest))
        {
        ...
        {
            MyDataMyConsent.Client.ApiResponse<PushUriResponse> localVarResponse = await IssuerIssuedoc1XmlPostWithHttpInfoAsync(pushUriRequest, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (PushUriResponse)</returns>
        public async System.Threading.Tasks.Task<MyDataMyConsent.Client.ApiResponse<PushUriResponse>> IssuerIssuedoc1XmlPostWithHttpInfoAsync(PushUriRequest pushUriRequest = default(PushUriRequest), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
