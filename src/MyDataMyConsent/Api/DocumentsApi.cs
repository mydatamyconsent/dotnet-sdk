...
namespace MyDataMyConsent.Api
{
    ...
    public partial class DocumentsApi : IDocumentsApi
    {
        ...
        {
            MyDataMyConsent.Client.ApiResponse<bool> localVarResponse = IssueDocumentWithHttpInfo(documentIssueRequest);
        ...
        /// <param name="documentIssueRequest"> (optional)</param>
        /// <returns>ApiResponse of bool</returns>
        public MyDataMyConsent.Client.ApiResponse<bool> IssueDocumentWithHttpInfo(DocumentIssueRequest documentIssueRequest = default(DocumentIssueRequest))
        {
        ...
        {
            MyDataMyConsent.Client.ApiResponse<bool> localVarResponse = await IssueDocumentWithHttpInfoAsync(documentIssueRequest, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (bool)</returns>
        public async System.Threading.Tasks.Task<MyDataMyConsent.Client.ApiResponse<bool>> IssueDocumentWithHttpInfoAsync(DocumentIssueRequest documentIssueRequest = default(DocumentIssueRequest), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        /// <param name="documentId">Document id.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public MyDataMyConsent.Client.ApiResponse<Object> V1DocumentsIssuedDocumentIdGetWithHttpInfo(Guid documentId)
        {
            MyDataMyConsent.Client.RequestOptions localVarRequestOptions = new MyDataMyConsent.Client.RequestOptions();
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<MyDataMyConsent.Client.ApiResponse<Object>> V1DocumentsIssuedDocumentIdGetWithHttpInfoAsync(Guid documentId, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        /// <param name="pageNo"> (optional, default to 1)</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public MyDataMyConsent.Client.ApiResponse<Object> V1DocumentsIssuedGetWithHttpInfo(Guid? documentTypeId = default(Guid?), DateTime? fromDateTime = default(DateTime?), DateTime? toDateTime = default(DateTime?), int? pageSize = default(int?), int? pageNo = default(int?))
        {
            MyDataMyConsent.Client.RequestOptions localVarRequestOptions = new MyDataMyConsent.Client.RequestOptions();
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<MyDataMyConsent.Client.ApiResponse<Object>> V1DocumentsIssuedGetWithHttpInfoAsync(Guid? documentTypeId = default(Guid?), DateTime? fromDateTime = default(DateTime?), DateTime? toDateTime = default(DateTime?), int? pageSize = default(int?), int? pageNo = default(int?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
